...
from .views import TeacherListCreateView, TeacherDetailView, TeacherCSVExportView,MyTeacherProfileView
...
urlpatterns = [
    ...
    path('me/', MyTeacherProfileView.as_view(), name='my-teacher-profile'),
]
